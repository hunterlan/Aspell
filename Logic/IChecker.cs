...
namespace Logic
{
    ...
    public interface IChecker
    {
        ...
        /// <param name="filesToIgnoreWords">Paths to files, where can get rules, which have to be ignored.</param>
        /// <returns>List of checked files, where can get mistakes.</returns>
        List<ResultProcessingFile> CheckComments(List<string> fileNames, List<string> filesToIgnoreWords);
    }
}